...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250127095515_revenueModelMigration")]
    partial class revenueModelMigration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Location.DeliveryAddressModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.SalesRecord.SalesRecordModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("RevenueModelId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("SellerId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<double>("TotalPreviousAmount")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Domain.Entities.SalesRecord.SellerRevenueModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.Location.DeliveryAddressModel", b =>
                {
                    b.HasOne("Domain.Entities.Foods.OrderModel", "Order")
                        .WithOne("DeliveryAddress")
                        .HasForeignKey("Domain.Entities.Location.DeliveryAddressModel", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.SalesRecord.SalesRecordModel", b =>
                {
                    b.HasOne("Domain.Entities.SalesRecord.SellerRevenueModel", "RevenueModel")
                        .WithMany()
